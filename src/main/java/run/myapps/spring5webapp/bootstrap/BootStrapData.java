package run.myapps.spring5webapp.bootstrap;
...
import run.myapps.spring5webapp.repositories.PublisherRepository;
...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Publisher publisher = new Publisher("MyNew Publishing","Publishing Road","Rome","Italy","00195");
        ...
        Book noEJB = new Book("J2EE Development without EJB", "777999666");
